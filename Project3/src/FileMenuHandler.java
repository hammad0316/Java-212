...
public class FileMenuHandler implements ActionListener {
	...
	public void ChoosingFile() {
		...
		inputFromFile(f, unsorted, sorted); //send in file, unsorted and sorted wordlist 
	} // method ChooseFile
	 ...
	 */
	private static void inputFromFile(File f, UnsortedWordList unsorted, SortedWordList sorted){
		...
		while (line != null ) {
			...
			while(st.hasMoreTokens()) {
				...
				if(temp.length() != Word.WORD_SIZE || !isLegalWord(temp))	{
